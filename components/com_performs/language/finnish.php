...
define("SUBMIT_LABEL","Lähetä");
define("PUBLISH","julkaise");
define("UNPUBLISH","lopeta julkaisu");
define("NAME","Nimi");
define("LINK","Linkki");
define("ITEMS","Kentät");
define("DB_TABLE_NAME","DB taulun nimi");
define("DB_RECORDS","DB tallenteet");
define("PUBLISHED","Julkaistu");
define("UNPUBLISHED","Julkaisematon");
define("SECURITYIMAGESHELP","Kuvavarmistuksen apua-viesti");
define("SECURITYIMAGESERROR","Kuvavarmistuksen virheviesti");

define("FORM_PREVIEW","Lomakkeen esikatselu");
define("DATE_TIME","PVM");
define("NO_RECORDS_FOUND","Ei tallennettuja tietoja!");
define("FIELD_NAMES","Kenttien nimet");
define('SELECT_FIELDS',"Select the field names, which you want to include in your report..");
define("ALL","Kaikki");
define("INCLUDED_FIELDS","Sisällytettyjen kenttien nimet");
define("UP","Ylös");
define("DOWN","Alas");
define("_PRINT","Tulosta");

define("USE_SECURITYIMAGES","Käytä kuvavarmistusta");
...
define("EDIT_FORM","Muokkaa lomaketta");
define("ADD_EDIT_REMOVE","Lisää, Muokkaa tai Poista lomakkeita");
define("CAPTION","Kentän nimi");
define("USE_CAPTION","Näytetäänkö kentän nimi:");
define("FIELD_SEPARATOR","Kenttien erotin:");
define("FIELD_SEPARATOR_INFO","Miten erotellaan kentät sähköpostiviestissä: uusi rivi, piste, puolipiste jne.");
define('USE_CAPTION_INFO',"When outputting form to email, perForms will print field names next to the value.");
define("FORMAT_TAB","Viestin muotoilu");
define("FORMAT_INFO","Raportin ja sähköpostin muotoilu");
define("TYPE","Tyyppi");
define("ORDER","Järjestys");
define("REORDER","Järjestä uudelleen");
define('INSERT', "Lisää");
define('REMOVE', "Poista");
define('SET_AS_SELECTED', "Set as SelectedF");
define("VALUE","Arvo");
define("EDIT_ITEM","Muokkaa");
define("EDIT","Muokkaa");
define("_NEW","Uusi");
define("FORM_DETAILS","Lomakkeen tiedot");
define("TITLE","Nimi järjestelmässä:");
define("INTRO_TEXT","Ingressiteksti:");
define("AFTER_SUBMIT","Lähetä toiminnon jälkeen:");
define("REDIRECT_TO_URL","Uudelleenohjaa osoitteeseen");
define("SHOW_TNX_TEXT","Näytä Kiitos viestistä -teksti");
define("REDIRECT_URL","Uudelleenohjauksen URL:");
define("TNX_TEXT","Kiitos-viesti:");
define("PUBLISHING_TAB","Julkaiseminen");
define("PUBLISHING_INFO","Julkaisemisen tiedot");
define("ACCESS","Vaadittava käyttäjätaso");
define("START_PUBLISHING","Aloita julkaisu");
define("FINISH_PUBLISHING","Lopeta julkaisu");
define("IMAGES_TAB","Kuvat");
define("IMAGE_INFO","Kuvatiedot");
define('IMAGE_INFO_INFO',"To use a custom image here, upload your image to ".$mosConfig_live_site."/images/stories");
define("IMAGE","Kuva");
define("THEMES_TAB","Teemat");
define("THEME_INFO","Teeman tiedot");
define("THEME","Teema");
define("BUTTONS_TAB","Painikkeet");
define("FORM_BUTTONS","Lomakkeen painikkeet");
define("SUBMIT_LABEL_TITLE","Lähetä-painike");
define("INCLUDE_RESET","Näytä myös Tyhjennä-painike");
define("INCLUDE_PF","Tulostusystävällinen versio");
define('INCLUDE_PDF',"Include PDF button");
define("INCLUDE_PF_INFO","Näytetäänkö lomakesivulla ikoni tulostusystävälliseen versioon");
...
define("RESET_LABEL","Tyhjennä-painikkeen teksti");
define("EMAILS_TAB","S-postiosoitteet");
define("EMAIL_FORM_TITLE","Lomakkeen otsikko");
define("EMAIL_FORM","Lomake lähetetään sähköpostitse:");
...
define("EMAIL_ALWAYS","Lähetä virheistä huolimatta:");
define('EMAIL_ALWAYS_INFO', "If yes, perForms will ignore errors and send the email anyway,");
define("FROM","Keneltä: (tyhjä - sivuston oletusosoitteesta)");
...
define("TO","Kenelle: (erota useampi osoite pilkulla)");
...
define("INTRO_INCLUDE","Sisällytä ingressiteksti mukaan:");
define('INTRO_INCLUDE_INFO', "If yes, the form intro will be included in the email.");
define("APPEND_TIMESTAMP","Lisätäänkö viestiin aikamerkintä:");
define("APPEND_TIMESTAMP_INFO","Sähköpostiin saapuvaan lomakkeeseen voidaan lisätä merkintä lähetysajasta.");

define("TABLE_ALREADY_CREATED","Taulu on jo luotu...");
define("CREATE_DATABASE_TABLE","Luo taulu tietokantaan..");
define("NOT_BOUND_TO_TABLE","Tätä lomaketta EI OLE tällä hetkellä sidottu tietokannan tauluun.");
define("BOUND_TO_TABLE","Tämä lomake on sidottu tietokannan tauluun nimeltä: ");
define('BOUND_INFO1',"When you bind a table to a form you can<strong>not</strong> add, edit or delete form elements.");
define("BOUND_INFO2","Taulun nimi <strong>ei saa</strong> sisältää välilyöntejä, tai muita erikoismerkkejä.");
define("TABLE_NAME","Taulun nimi:");

define("DELETE_FORM_INFO1","Tämä lomake on jo sidottu tauluun '%s' " );
define("DELETE_FORM_INFO2","Jos poistat taulun, kaikki siihen tallennettu tieto häviää samalla.");
define("DELETE_FORM_INFO3","POISTETTUJA TIETOJA EI PYSTYTÄ PALAUTTAMAAN");
define("DELETE_TABLE","Poistetaanko taulu?");
define("FORM_ITEMS_DETAILS","Lomakkeen tiedot");
define("NO_SPECIAL_CHARS","Ei välilyöntejä eikä erikoismerkkejä!");
define("CHECK","Tarkista");
define("HELP_TEXT","Apua teksti");
define("ERROR_MSG","Virheviesti");
define("DISPLAY_TAB","Näytä");
define("DISPLAY_PROP","Näytä ominaisuudet");
define("SIZE1","Koko 1");
define("SIZE2","Koko 2");
define('SIZE1_INFO',"Width, Columns");
define('SIZE2_INFO',"Height, Rows, <br/>Max Upload Size (bytes)");
define("REQUIRED","Pakollinen");
define('REQUIRED_INFO',"PerForms will not allow a form to be submitted unless this field is filled in.");
define("DISABLED","Ei käytössä");
define("READONLY","Vain luku");
define("MULTIPLE","Useita vaihtoehtoja");
define('MULTIPLE_INFO',"For use with \&apos;Select\&apos; elements.");
define("VALUES_TAB","Arvot");
define("VALUES_INFO","Arvojen tiedot");
define("MISSING_FIELD_TEXT","Puuttuvan kentän teksti:");

// Errors
define("ITEMS_CANT_EDITED","Tämän lomakkeen kenttiä ei voi editoida!");
define("FORM_CURRENTLY_EDITED","Lomaketta %s muokkaa juuri toinen ylläpitäjä.");
define("NO_FORM_FOUND","Lomaketta ei löydy !");
define("SELECT_A_RECORD_TO","Valitse tietueet %s");
define("ALREADY_TABLE_EXISTS","Taulu \'%s\' on jo olemassa, anna toinen nimi.");
define("ERROR_OCCURRED","Virhe toiminto!");
define("DB_ERROR_OCCURRED","Virhe kirjoitettaessa tietokantaan!");
define("TITLE_EMPTY","Otsikko on tyhjä!");
define("TABLE_NAME_EMPTY","Sinun on annettava taululle nimi.");
define("DELETE_DATA_CONFIRM","Haluatko varmasti poistaa kaiken tallennetun tiedon?");
define("CAPTION_EMPTY","Kuvateksti on tyhjä.");
define("NAME_EMPTY","Nimi on tyhjä");
define("LIST_VALUES","Listaa arvot");
define("SELECTED_VALUE","Oletusarvo");
...
define("DATABASE","Tietokanta");
define('BOUNDDATA',"Data");
define("EXPORTTOEXCEL","Vie");
define("PREVIEW","Esikatselu");
define("CLOSE","Sulje");
define("CANCEL","Peruuta");
define("DELETE","Poista");
define("COPY_RECORD","Kopioi");
define("NEW_ITEM","Uusi kenttä");
define("DELETE_ITEM_CONFIRM","Poista lomake?");
define("SAVE","Tallenna");

define('PRINTER_FRIENDLY', "Printer Friendly");
define('DOWNLOAD_PDF', "Download PDF");
define("ACCESSKEY","Pikanäppäin aktivointiin");
...
define('TY_EMAIL', 'emailF');
define('TY_FLOAT', 'floatF');
define('TY_INTEGER', 'integerF');
define('TY_NAME', 'nameF');
define('TY_STRING', 'stringF');
define('TY_URL', 'urlF');

define('ITEMTYPE_BUTTON', 'buttonFI');
define('ITEMTYPE_CHECKBOX', 'checkboxFI');
define('ITEMTYPE_DATE', 'dateFI');
define('ITEMTYPE_FILE', 'fileFI');
define('ITEMTYPE_HIDDEN', 'hiddenFI');
define('ITEMTYPE_IMAGE', 'imageFI');
define('ITEMTYPE_PASSWORD', 'passwordFI');
define('ITEMTYPE_PAGEBREAK', 'pagebreakFI');
define('ITEMTYPE_RADIO', 'radioFI');
define('ITEMTYPE_SELECT', 'selectFI');
define('ITEMTYPE_TEXT', 'textFI');
define('ITEMTYPE_TEXTAREA', 'textareaFI');
define('ITEMTYPE_TEXTUAL', 'textualFI');
