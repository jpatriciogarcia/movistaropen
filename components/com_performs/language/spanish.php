...
define("SUBMIT_LABEL","Agregar");
define("PUBLISH","publicar");
define("UNPUBLISH","no publicar");
define("NAME","Nombre");
define("LINK","Enlace");
define("ITEMS","Artículos");
define("DB_TABLE_NAME","Nombre de tabla en BD");
define("DB_RECORDS","Registros en BD");
define("PUBLISHED","Publicado");
define("UNPUBLISHED","No publicado");
define("SECURITYIMAGESHELP","Mensaje de ayuda de imagen de seguridad");
define("SECURITYIMAGESERROR","Mensaje de error de imagen de seguridad");

define("FORM_PREVIEW","Visualizar formulario");
define("DATE_TIME","Fecha");
define("NO_RECORDS_FOUND","Registros no encontrados!");
define("FIELD_NAMES","Nombres de campos");
define("SELECT_FIELDS","Selecione los nombres de los campos que desea incluir en el reporte..");
define("ALL","Todo");
define("INCLUDED_FIELDS","Nombres de campos incluidos");
define("UP","Arriba");
define("DOWN","Abajo");
define("_PRINT","Imprimir");

define("USE_SECURITYIMAGES","Usar imagenes de seguridad");
...
define("EDIT_FORM","Editar formulario");
define("ADD_EDIT_REMOVE","Agregar, Editar or Eliminar artículos del formulario");
...
define('REMOVE', "Remote");
define('SET_AS_SELECTED', "Set as Selected");
define("VALUE","Valor");
define("EDIT_ITEM","Editar artículo");
define("EDIT","Editar");
define("_NEW","Nuevo");
define("FORM_DETAILS","Detalles del formulario");
define("TITLE","Título:");
define("INTRO_TEXT","Texto introductorio:");
define("AFTER_SUBMIT","Despues de enviar:");
define("REDIRECT_TO_URL","Redireccionar al Url");
define("SHOW_TNX_TEXT","Mostrar texto de agradecimiento");
define("REDIRECT_URL","Url redireccionado:");
define("TNX_TEXT","Texto de agradecimiento:");
define("PUBLISHING_TAB","Publicación");
define("PUBLISHING_INFO","Información de publicación");
define("ACCESS","Accesar");
define("START_PUBLISHING","Inicio de publicación");
define("FINISH_PUBLISHING","Final de publicación");
define("IMAGES_TAB","Imágenes");
define("IMAGE_INFO","Información de imágen");
define('IMAGE_INFO_INFO',"To use a custom image here, upload your image to ".$mosConfig_live_site."/images/stories");
define("IMAGE","Imágen");
define("THEMES_TAB","Temas");
define("THEME_INFO","Información de Tema");
define("THEME","Tema");
define("BUTTONS_TAB","Botones");
define("FORM_BUTTONS","Botones del formulario");
define("SUBMIT_LABEL_TITLE","Agregar etiqueta");
define("INCLUDE_RESET","Incluir boton de Reset");
...
define("EMAIL_ALWAYS","Enviar incluso si hay error:");
define('EMAIL_ALWAYS_INFO', "If yes, perForms will ignore errors and send the email anyway,");
define("FROM","De: (en blanco para utlizar el del site por defecto)");
...
define("TO","Para: (lista separada por comas)");
...
define("EMAIL_SUBJECT","Asunto del E-mail:");
...
define("INTRO_INCLUDE","Incluir texto introductorio:");
...
define("TABLE_ALREADY_CREATED","La tabla ya ha sido creada...");
define("CREATE_DATABASE_TABLE","Crear una tabla en la base de datos..");
define("NOT_BOUND_TO_TABLE","Este formulario no esta introducido en la base de datos .");
define("BOUND_TO_TABLE","Este formulario ya esta en la base de datos . Nombre de tabla: ");
define("BOUND_INFO1","Cuando unes una tabla a un formulario <strong>no</strong> puedes agregar, editar o borrar elementos del formulario.");
define("BOUND_INFO2","El nombre de la tabla <strong>no debe</strong> contener espacion, periods o carcateres especiales.");
define("TABLE_NAME","Nombre de tabla:");

define("DELETE_FORM_INFO1","Este formulario ya esta asignado a '%s' " );
define("DELETE_FORM_INFO2","Si borras la tabla, toda los datos serán eliminados incluso la tabla será eliminada.");
define("DELETE_FORM_INFO3","NO HAY MANERA DE RESTAURAR ESTA INFORMACION UNA VEZ ELIMINADA");
define("DELETE_TABLE","Borrar tabla?");
define("FORM_ITEMS_DETAILS","Detalles de los artículos del formulario");
define("NO_SPECIAL_CHARS","Sin espacios, periods o caracteres especiales!");
define("CHECK","Revisar");
define("HELP_TEXT","Texto de ayuda");
define("ERROR_MSG","Mensaje de error");
define("DISPLAY_TAB","Presentación");
define("DISPLAY_PROP","Propiedades de presentación");
define("SIZE1","Tamaño 1");
define("SIZE2","Tamaño 2");
...
define("READONLY","Solo lectura");
define("MULTIPLE","Múltiples");
define('MULTIPLE_INFO',"For use with \&apos;Select\&apos; elements.");
define("VALUES_TAB","Valores");
define("VALUES_INFO","Información de los valores");
define("MISSING_FIELD_TEXT","Testo de campos perdidos:");

// Errors
define("ITEMS_CANT_EDITED","Los artículos de este formulario no pueden ser editados!");
define("FORM_CURRENTLY_EDITED","El formulario %s está siendo editado por otro administrador.");
define("NO_FORM_FOUND","Formulario no encontrado !");
define("SELECT_A_RECORD_TO","Select a record to %s");
define("ALREADY_TABLE_EXISTS","La tabla \'%s\' ya existe, por favor ingrese un nombre diferente.");
define("ERROR_OCCURRED","Un error ha ocurrido!");
define("DB_ERROR_OCCURRED","Error escribiendo a la base de datos!");

define("TITLE_EMPTY","El título está en blanco!");
define("TABLE_NAME_EMPTY","Debe ingresar un nombre para la tabla.");
define("DELETE_DATA_CONFIRM","Realmente desea borrar TODOS LOS DATOS?");
define("CAPTION_EMPTY","Caption is empty.");
define("NAME_EMPTY","El nombre esta vacío");
define("LIST_VALUES","Mostrar valores");
define("SELECTED_VALUE","Valores seleccionados");
...
define('PF_ERROR_18_COMMENT', 
       ...
       .'<li>Also occurs when joomla global config setting "Live Site" '
...
define("NEW_ITEM","Nuevo artículo");
define("DELETE_ITEM_CONFIRM","Borrar artículo?");
define("SAVE","Guardar");
