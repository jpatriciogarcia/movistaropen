...
define("FINISH_PUBLISHING","Beïndig publiceren");
...
define("CREATE_DATABASE_TABLE","Creër een database-tabel..");
...
define("BOUND_INFO2","De tabelnaam <strong>mag géén</strong> spaties, punten of speciale karakters bevatten.");
