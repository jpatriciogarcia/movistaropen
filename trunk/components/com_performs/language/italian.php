...
define("FORM", "Form");
define("SUBMIT_LABEL","invia");
define("PUBLISH","pubblica");
define("UNPUBLISH","non pubblicare");
define("NAME","Nome");
define("LINK","Link");
define("ITEMS","Elementi");
define("DB_TABLE_NAME","Nome tabella DB");
define("DB_RECORDS","Elementi DB");
define("PUBLISHED","Pubblicato");
define("UNPUBLISHED","Non Pubblicato");
define("SECURITYIMAGESHELP","messaggio di aiuto Security image");
define("SECURITYIMAGESERROR","messaggio di errore Security image");

define("FORM_PREVIEW","Anteprima Form");
define("DATE_TIME","Data");
define("NO_RECORDS_FOUND","Nessun elemento trovato!");
define("FIELD_NAMES","Nomi dei campi");
define("SELECT_FIELDS","Selezionare i nomi dei campi da includere nel report..");
define("ALL","Tutti");
define("INCLUDED_FIELDS","Nomi dei campi inclusi");
define("UP","Su");
define("DOWN","Giu");
define("_PRINT","Stampa");

define("USE_SECURITYIMAGES","Usa securityimages");
define('NO_SI_INSTALLED', 'com_securityimages non installato');
define('NO_SI_INSTALLED_INFO', '<ul><li>Scaricalo da <a href="http://extensions.joomla.org/component/option,com_mtree/task,viewlink/link_id,1211/Itemid,35/">Joomla! Extensions</a></li><li>PerForms funziona senza problemi anche senza.</li></ul>');
define("EDIT_FORM","Modifica Form");
define("ADD_EDIT_REMOVE","Aggiungi, Modifica o Rimuovi elementi del Form");
define("CAPTION","Etichetta");
define('USE_CAPTION',"Usa Etichetta");
define('FIELD_SEPARATOR', "Carattere Separatore");
define('FIELD_SEPARATOR_INFO', "Nell'uscita in email o in formato testo, questo carattere sarà usato tra i valori delle opzioni.");
define('USE_CAPTION_INFO',"When outputting form to email, perForms will print field names next to the value.");
define('FORMAT_TAB',"Formato");
define('FORMAT_INFO', "Formattazione Report ed Email");
define("TYPE","Type");
define("ORDER","Ordina");
define("REORDER","Riordina");
define('INSERT', "Inserisci");
define('REMOVE', "Rimuovi");
define('SET_AS_SELECTED', "Mostra come Selezionato");
define("VALUE","Valore");
define("EDIT_ITEM","Modifica Elemento");
define("EDIT","Modifica");
define("_NEW","Nuovo");
define("FORM_DETAILS","Dettagli Form");
define("TITLE","Titolo:");
define("INTRO_TEXT","Testo Introduttivo:");
define("AFTER_SUBMIT","Dopo l'invio:");
define("REDIRECT_TO_URL","Invia alla pagina");
define("SHOW_TNX_TEXT","Mostra testo di ringraziamento");
define("REDIRECT_URL","Url pagina di redirect:");
define("TNX_TEXT","Testo di ringraziamento:");
define("PUBLISHING_TAB","Pubblicazione");
define("PUBLISHING_INFO","Info sulla Pubblicazione");
define("ACCESS","Accesso");
define("START_PUBLISHING","Inizio Pubblicazione");
define("FINISH_PUBLISHING","Fine Pubblicazione");
define("IMAGES_TAB","Immagini");
define("IMAGE_INFO","Info Immagine");
...
define("THEMES_TAB","Temi");
define("THEME_INFO","Info Temi");
define("THEME","Tema");
define("BUTTONS_TAB","Pulsanti");
define("FORM_BUTTONS","Pulsanti Form");
define("SUBMIT_LABEL_TITLE","Etichetta invio");
define("INCLUDE_RESET","Includi pulsante di reset");
define("INCLUDE_PF","Includi pulsante Stampa Ottimizzata");
define("INCLUDE_PDF","Includi pulsante PDF");
...
define("RESET_LABEL","Etichetta Reset");
define("EMAILS_TAB","E-Mail");
define("EMAIL_FORM_TITLE","Email Form");
define("EMAIL_FORM","Email Form:");
define('EMAIL_FORM_INFO', "Se si, perForms invierà un email all'invio del form.");

define('EMAIL_ADMIN',"Invia copia all'admin:");
...
define('EMAIL_USER',"Invia copia all'utente:");
...
define("EMAIL_ALWAYS","Invia anche in presenza di errori:");
...
define("EMAIL_SUBJECT","Oggetto dell'E-mail:");
...
define("INTRO_INCLUDE","Includi Testo Introduzione:");
define('INTRO_INCLUDE_INFO', "Se si, il testo dell'introduzione sarà incluso nell'email.");
define('APPEND_TIMESTAMP', "Aggiungi Data e ora");
define('APPEND_TIMESTAMP_INFO', "Se si, all'oggetto dell'email verrà aggiunta la Data e l'ora dell'invio del Form.");

define("TABLE_ALREADY_CREATED","Tabella esistente...");
define("CREATE_DATABASE_TABLE","Crea una tabella del database..");
define("NOT_BOUND_TO_TABLE","Questo form attualmente NON è collegato a una tabella del database.");
define("BOUND_TO_TABLE","Questo form attualmente è collegato alla tabella del database: ");
define("BOUND_INFO1","When you bind a table to a form you can<strong>not</strong> add, edit or delete form elements.");
define("BOUND_INFO2","Nome tabella <strong>NON DEVE</strong> contenere spazi, virgole o caratteri speciali.");
define("TABLE_NAME","Nome Tabella:");
...
define("FOR_MORE_HELP", 'For more help using PerForms, see '
       .'the PerForms home page, at <a href="http://jext.info/content/view/9/20/"> '
       .'jext.info</a>');
...
define('FOR_SUPPORT', @"
<p><b>For support, please visit the official support site at <a href=\"http://performs.jext.info/\">http://performs.jext.info/</a>.</b></p>
");
