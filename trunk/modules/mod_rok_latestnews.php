...
* @version 1.0
* @package RocketTheme
* @copyright RocketTheme (C) 2007 - Copyright (C) 2005 Open Source Matters. All rights reserved.
* @license http://www.gnu.org/copyleft/gpl.html GNU/GPL, see LICENSE.php
*
* This module is a modification of the Joomla! 1.0.12 latestnews module
* 
...
switch ( $type ) {
	...
	//Content Items only
		...
		$query = "SELECT a.id, a.title, a.sectionid, a.catid, a.created"
		. "\n FROM #__content AS a"
		. "\n LEFT JOIN #__content_frontpage AS f ON f.content_id = a.id"
...
foreach ( $rows as $row ) {
	...
	<li class="latestnews<?php echo $moduleclass_sfx; ?>">
		<a href="<?php echo $link; ?>" class="latestnews<?php echo $moduleclass_sfx; ?>">
			...
			<span class="created-date"><?php echo $row->created; ?></span>
	</li>
	<?php
}
?>
